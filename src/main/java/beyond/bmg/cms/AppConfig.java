...
@Configuration
@PropertySource({"classpath:/beyond/bmg/cms/conf/jdbc.properties",
                 "classpath:/beyond/bmg/cms/conf/sec.properties"})
@MapperScan("beyond.bmg.cms.dao")
...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    try {
      ...
      factory.setTypeAliasesPackage("beyond.bmg.cms.domain");

      // SQL 맵퍼 파일 경로를 등록한다.
      factory.setMapperLocations(appCtx.getResources(
          "classpath:/beyond/bmg/cms/mapper/**/*.xml"));
